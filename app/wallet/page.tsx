...
export default function WalletPage() {
    return (
        <div className="min-h-screen bg-black text-foreground flex flex-col relative overflow-hidden">
            {/* Ambient Background */}
            <div className="pointer-events-none absolute top-[-20%] left-[-10%] h-[1000px] w-[1000px] rounded-full bg-violet-600/10 blur-[120px]" />
            <div className="pointer-events-none absolute bottom-[-20%] right-[-10%] h-[800px] w-[800px] rounded-full bg-fuchsia-600/10 blur-[120px]" />
