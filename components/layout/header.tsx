...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#0a0f0a]/95 backdrop-blur-xl">
        ...
        <div className="hidden flex-1 items-center justify-center md:flex">
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              className="w-full rounded-lg border border-white/8 bg-white/4 py-2 pl-10 pr-16 text-sm text-white placeholder:text-white/30 transition-all duration-200 hover:bg-white/[0.06] hover:border-white/[0.12] focus:bg-white/[0.08] focus:border-white/[0.15] focus:outline-none focus:ring-1 focus:ring-white/[0.08]"
            />
            {/* ⌘K shortcut badge */}
            <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-0.5 pointer-events-none">
              <kbd className="flex h-5 items-center rounded border border-white/10 bg-white/6 px-1.5 text-[10px] font-medium text-white/30">
                ⌘
              </kbd>
              <kbd className="flex h-5 items-center rounded border border-white/10 bg-white/6 px-1.5 text-[10px] font-medium text-white/30">
                K
          ...
          <Sheet key="mobile-menu">
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px] border-l border-white/[0.06] bg-[#0a0f0a]">
              ...
              <div className="mt-8 flex flex-col gap-4">
                {/* Mobile Search */}
                <div key="mobile-search-bar" className="relative px-1">
                ...
                {authenticated && user && (
                  <div key="mobile-user-card" className="flex flex-col gap-3 px-4 py-4 rounded-lg bg-white/[0.04] border border-white/[0.06]">
                ...
                <Link key="link-home" href="/" className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-white/[0.04] transition-colors text-white/70 hover:text-white">
                  <Home className="h-5 w-5" />
                  <span className="font-medium">Home</span>
                </Link>

                {authenticated && (
                  <Link key="link-wallet" href="/wallet" className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-white/[0.04] transition-colors text-white/70 hover:text-white">
                ...
                {authenticated && hasCreationRights && (
                  <Link key="link-create" href="/create-market" className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-white/[0.04] transition-colors text-white/70 hover:text-white">
      ...
      {searchOpen && (
        <div key="mobile-search-overlay" className="border-t border-white/[0.06] px-4 py-3 md:hidden bg-[#0a0f0a]/98 backdrop-blur-xl">
